package com.example.cerita_dongeng.utils
...
class FirebaseHelper {
    ...
    // new
    fun insertDataToFirebase(title: String, story: String, imgPath: String, callback: (Boolean, String?) -> Unit) {
        ...
        val data = mapOf(
            ...
            "strJudul" to title,
            "strCerita" to story,
            "imagePath" to imgPath, // tambahkan path gambar
    ...
    fun editData(id: String, title: String, story: String, imgPath: String, callback: (Boolean, String?) -> Unit) {
        val data = mapOf(
            "id" to id,
            "strJudul" to title,
            "strCerita" to story,
            "imagePath" to imgPath,
            "date" to formatDateTime()
        )
